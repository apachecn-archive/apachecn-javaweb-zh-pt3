...
6.  我们现在准备启动我们的应用。首先，让我们使用`./gradlew clean bootRun`命令，如果我们查看 JConsole VM Summary 选项卡，我们会看到我们的参数确实已经被传递给 JVM，如下所示:![](img/dd0b250c-6176-4663-9d7f-d74644feb2fe.png)
