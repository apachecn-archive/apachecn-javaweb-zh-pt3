...
4.  通过运行`./gradlew clean bootRun`启动应用
5.  应用启动后，打开浏览器并转到`http://localhost:8080/authors`，您应该会看到以下响应:![](img/71ab0b14-d267-43a9-a664-393a315e3ff5.png) 
...
8.  让我们在浏览器中打开`http://localhost:8080/books/978-1-78528-415-1/reviewers`，你应该能看到以下结果:![](img/1e5987be-68ce-4e93-b772-67b5b6403036.png)
