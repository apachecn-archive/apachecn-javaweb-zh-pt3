...
在本章中，你将学习基于 GraphQL 的 API 开发及其测试。在本章中，您将为一个示例应用实现基于 GraphQL 的 API。GraphQL 服务器实现将基于**设计优先**的方法进行开发，您在 [*第 3 章*](B16561_03_Epub_AM.xhtml#_idTextAnchor064) 、 *API 规范和实现*中定义 OpenAPI 规范的方式，以及在 [*第 11 章*](B16561_11_Epub_AM.xhtml#_idTextAnchor230) 、*基于 gRPC 的 API 开发和测试*中设计模式的方式。
...
](img/Figure_14.1_B16561-CV111.jpg)
...
您已经完成了订阅`quantityChanged`的实施。接下来可以测试一下。
