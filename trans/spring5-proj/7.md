...
如果你对百里香不是很熟悉，它是一个用来产生视图的自然模板引擎，视图是在服务器端处理的。在本书的[第三章](e32452e8-07bb-4815-96d6-b0db0a6009ba.xhtml)*《Blog press——一个简单的博客管理系统》*中有详细的解释。你可以参考它来了解百里香是如何与Spring一起工作的。
