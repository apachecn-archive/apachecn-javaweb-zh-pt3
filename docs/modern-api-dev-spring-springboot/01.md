...
这些社交登录使用 REST 和 GraphQL 提供 API。目前，REST 是使用最广泛的，它已经成为编写用于集成和 web 应用程序消费的 API 的标准。我们还将在本书的最后几章详细讨论 GraphQL(在 [*第十三章*](13.html#_idTextAnchor263) 、 *GraphQL 基础*和 [*第十四章*](14.html#_idTextAnchor286) 、 *GraphQL 开发和测试*)。
...
![Figure 1.1 – The URI hierarchy ](Images/Figure_1.1_B16561.jpg)
...
![Figure 1.2 – The e-commerce app architecture ](Images/Figure_1.2_B16561.jpg)
