...
![Client is the king](graphics/2117_5_1.jpg)
...
我们差不多完成了。如果您重启应用程序并转到`http://localhost:8080/api/search/mixed;keywords=springFramework`，您将看到日期格式不是我们预期的格式:

![Customizing the JSON output](graphics/2117_05_02.jpg)
...
![Customizing the JSON output](graphics/2117_05_03.jpg)
...
![Documentation with Swagger](graphics/2117_05_04.jpg)
...
![Generating XML](graphics/2117_05_05.jpg)

那是因为你的浏览器一般不会请求 JSON，但是 XML 排在 HTML 之后。如下图所示:

![Generating XML](graphics/2117_05_06.jpg)
...
![The check point](graphics/2117_05_07.jpg)
