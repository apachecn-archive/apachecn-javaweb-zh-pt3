...
![Cache control](graphics/2117_08_01.jpg)
...
现在，为了使用这个实现，我们需要使用`async`概要文件运行应用程序。
...
为了在我们的应用程序中配置 WebSockets，我们还需要添加一些配置:
...
![The check point](graphics/2117_08_03.jpg)
