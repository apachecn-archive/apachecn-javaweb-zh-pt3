...
在我们的例子中，我们已经使用 Spring 注释`@RestController`创建了一个控制器。正如我们在[第 2 章](02.html#29DRA0-005ba5e9819e4f499f11aaac5b7181c1)、*Spring Boot 2.0 入门*中所理解的那样，这个控制器将在应用程序启动时被组件扫描获得，并将作为 bean 添加到我们的 Spring 上下文中。
